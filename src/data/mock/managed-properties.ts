...
export const mockManagedProperties: ManagedProperty[] = [
  {
    ...
    performance: { views: 1240, saves: 86, enquiries: 24, bookingRequests: 6, period: "Last 30 days" },
    verification: verification("verified"),
    scouts: [
      scoutAssignment("scout_001", "Emmanuel Etim", true, "active", fullPermissions, "2026-07-02T09:00:00Z"),
    ],
    activity: activity([
      ["view", "Property viewed 24 times", "Students who searched near UNICAL", "2026-09-07T06:00:00Z"],
  ...
  },
  {
    ...
    performance: { views: 312, saves: 21, enquiries: 4, bookingRequests: 0, period: "Last 30 days" },
    verification: verification("pending", { property_review: "pending", images: "pending" }),
    scouts: [
      scoutAssignment("scout_002", "Aisha Bello", true, "active", limitedPermissions, "2026-08-14T09:00:00Z"),
    ],
    activity: activity([
      ["status", "Submitted for review", "Awaiting Camp Match verification", "2026-08-30T09:00:00Z"],
  ...
  },
  {
    ...
    availability: { status: "temporarily_unavailable", availableFrom: "2026-09-20", unitsAvailable: 1 },
    ...
    scouts: [],
    activity: activity([
      ["status", "Changes requested", "Clearer photos of the shared bathroom", "2026-09-01T11:00:00Z"],
  ...
  },
  {
    ...
    performance: { views: 890, saves: 54, enquiries: 15, bookingRequests: 4, period: "Last 30 days" },
    verification: verification("verified"),
    scouts: [
      scoutAssignment("scout_001", "Emmanuel Etim", true, "active", fullPermissions, "2026-07-20T09:00:00Z"),
    ],
    activity: activity([
      ["enquiry", "New enquiry received", "Asking about instalment payment", "2026-09-05T09:10:00Z"],
  ...
  },
  {
    ...
    performance: { views: 402, saves: 18, enquiries: 3, bookingRequests: 1, period: "Last 30 days" },
    verification: verification("rejected", { property_review: "rejected", images: "rejected" }),
    scouts: [
      scoutAssignment("scout_004", "Tolu Adeyemi", false, "pending", limitedPermissions, "2026-08-29T09:00:00Z"),
    ],
    activity: activity([
      ["status", "Listing suspended", "Photos did not match the scout visit", "2026-09-03T15:00:00Z"],
    ]),
