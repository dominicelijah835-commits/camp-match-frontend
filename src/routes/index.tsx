      ...
      <div className="space-y-8 py-6">
        ...
        <div className="px-4 sm:px-6">
          <div className="flex items-start gap-3 rounded-2xl border border-border bg-primary-soft p-4">
            ...
            <p className="text-sm text-foreground">
              <span className="font-semibold">Verified before you pay.</span> Every
              Camp Match listing is visited by a Scout who confirms the landlord,
        ...
        <div className="px-4 sm:px-6">
          <div className="flex items-start gap-3 rounded-2xl border border-border bg-surface p-4">
            ...
            <p className="text-sm text-muted-foreground">
              You're viewing demo data. Bookings, messages and payments arrive in
              later phases.
            </p>
          </div>
        </div>
