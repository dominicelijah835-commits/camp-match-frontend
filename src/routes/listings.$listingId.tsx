...
import {
  VerificationBadge,
  VerificationCard,
} from "@/components/listings/verification-badge";
  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Property details — Camp Match" },
      {
        ...
        content:
          "Photos, verification checks and Scout details for this verified student home.",
      },
    ],
  }),
            ...
            <div className="sticky top-20 space-y-4">
              <div className="rounded-2xl border border-border bg-surface p-5 shadow-card">
                ...
                <p className="mt-1 text-sm text-muted-foreground">
                  ...
                  {listing.availability.unitsAvailable > 1 ? "s" : ""} available
                  from {listing.availability.availableFrom}
                </p>
                <Button
