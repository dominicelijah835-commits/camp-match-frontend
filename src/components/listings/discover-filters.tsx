  ...
  return (
    <div className="space-y-6 rounded-2xl border border-border bg-surface p-5">
      ...
      <div className="space-y-3">
        <div className="flex items-center justify-between">
          <Label htmlFor="max-price" className="text-xs uppercase tracking-wide text-muted-foreground">
            Max price
          </Label>
      ...
      <div className="space-y-3">
        <div className="flex items-center justify-between">
          <Label htmlFor="max-distance" className="text-xs uppercase tracking-wide text-muted-foreground">
            Max distance
          </Label>
